# ch08-08 연습문제 (본문 게재 코드 원본 4문항 — writer 기계적 추출, 미실행)
# 검증 대상(fact-checker 실행 예정): python3
# 출력·반환 자구 assert — perfect·nsum 값, gcd 3 vs 6(수정 전/후), None TypeError. 트레이스백 게재 0건.
...
try:
    print(biggest * 2)
    raise AssertionError("도달하면 오류: None과 곱셈했는데 성공함")
