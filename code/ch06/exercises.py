# ch06 연습문제(07-exercises.md) 코드 검증용 원본 — python3 실행 검증 2026-07-12
# 브리프: 원료 없음, 전 문항 자체 제작. for/while/def/input 미사용(장 규율).
...
# 문항 3 — 이 코드, 어디가 이상할까 (오답: 독립 if 세 개, 03절 함정 재연)
score = 95
if score >= 90:
    print("A")
if score >= 80:
...
# 문항 4 — 이 코드, 어디가 이상할까 (오답: `or "일"`이 항상 참, 05절 채권 회수)
day = "월"
if day == "토" or "일":
    print("주말입니다")
else:
