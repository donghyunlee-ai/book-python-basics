# ch05-01 나눗셈의 두 얼굴 — 몫과 나머지 (본문 게재 코드 원본, 5셀 구성)
# 검증 대상(fact-checker 실행 예정): python3
# 출력 예상: 3.0/2.0 | 3/2/17 | 3.0 | 평균 점수: 3 / 평균 점수: 3.5 | -4/-3 | 0/1/9/37 | ZeroDivisionError
...
# 셀 6 — 0으로 나누기는 거절당한다 (ZeroDivisionError, 마지막 줄만 본문 인용)
try:
    print(10 / 0)
