# 13장 3절 무엇을 잡을 것인가 — 에러의 가족과 넓은 그물
# 이 절의 예제 3개(다중 except, as e, bare except 삼킴)를 묶었다.
import os
...
def as_e_demo():
    ...
    try:
        number = int("삼")  # noqa: F841 (책과 같은 코드: 실패를 보여주는 것이 목적)
...
def bare_except_swallow_demo():
    ...
    except:  # noqa: E722 (bare except — 책이 경계하는 바로 그 안티패턴)
