# ch09-03 파일을 읽다 — read와 줄 순회 (본문 게재 코드 원본, 9셀 구성)
# 검증 대상(fact-checker 실행 예정): python3
# 산출 파일: scores.txt (스크립트 말미에서 삭제)

import os

# 셀 0 — 실습 재료 파일 scores.txt 준비(본문 게재)
f = open("scores.txt", "w")
f.write("85\n90\n70\n")
f.close()
...
# 셀 7 — 문자열 + 정수는 TypeError (본문은 주석으로만 제시)
line = "5\n"
...
# 셀 9 — 없는 파일을 읽으면 FileNotFoundError (본문은 주석 예시, 여기서는 실증)
try:
    open("없는파일.txt", "r")
