# ch04-06 네 그릇의 지도 — 본문 코드 원본
# 검증: python3 실행, 전 출력 결정적(문자열 집합은 만들기만 하고 출력하지 않음 — 순서 비보장 규율)
...
# 표 4-1 "변경" 열의 사실 확인: 리스트·딕셔너리·집합은 고칠 수 있고 튜플은 거절
submissions.append("최집합")
scores["최집합"] = 70
takers.add("최집합")
try:
    exam[0] = "데이터 기초"
    raise SystemExit("도달하면 오류: 튜플이 항목 할당을 받아들임")
